...
function Cart() {
  ...
  const calcShipping = (shipPrice) => {
    return cart.length && shipPrice;
  };
          ...
          <>
            ...
            <div className="cart__checkout-price">
              <div className="cart__sub-total">
                ...
                <p className="cart__sub-total--price">$ {total}</p>
              </div>
              <div className="cart__shipping">
                <p className="cart__shipping--heading">Shipping</p>
                <p className="cart__shipping--price">$ {calcShipping(5.99)}</p>
              </div>
              <div className="cart__total">
                <p className="cart__total--heading">Total</p>
                <p className="cart__total--price">
                  $ {total + calcShipping(5.99)}
                </p>
              </div>
            </div>
            <button className="btn" onClick={() => getTotalPrice()}>
              Place order
            </button>
          </>) : <h3>No items</h3>
        }
